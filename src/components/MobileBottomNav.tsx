...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-slate-950/95 backdrop-blur-2xl border-t border-slate-800/80 px-1 pt-1.5 pb-safe shadow-2xl">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <motion.button
              ...
              className={`relative flex flex-col items-center justify-center min-h-[48px] min-w-[48px] py-1 px-1 rounded-xl text-[9px] font-extrabold transition-all cursor-pointer touch-callout-none ${
                isActive
            ...
            >
              ...
              <span className="truncate tracking-tighter max-w-[56px] text-center">{tab.label}</span>
            </motion.button>
          );
        })}
      </div>
