...
export const StreakCelebrationModal: React.FC<StreakCelebrationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-2xl animate-fade-in overflow-y-auto">
      ...
      <div className="relative w-full max-w-md mx-auto my-auto bg-slate-900 border-2 border-amber-500/60 rounded-[2.5rem] p-6 sm:p-8 shadow-2xl shadow-amber-500/40 text-center space-y-6 z-10 animate-scale-up">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="relative w-28 h-28 mx-auto rounded-full bg-gradient-to-tr from-rose-600 via-amber-500 to-yellow-400 p-1 flex items-center justify-center shadow-2xl shadow-rose-500/50 animate-bounce">
          ...
          <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-3.5 py-0.5 rounded-full bg-rose-600 text-white text-[11px] font-black uppercase tracking-wider border border-amber-300 shadow-md whitespace-nowrap">
            +1 NGÀY CHUỖI LỬA
          </div>
        </div>
