        ...
        "practice": [
          ...
          },
          {
            ...
            "sequenceItems": [
              {
                "id": "step-a",
                "stepText": "Dừng ngay mọi giao dịch & Khóa khẩn cấp thẻ/Internet Banking trên app chính thức hoặc gọi Hotline ngân hàng",
                "correctOrder": 1,
                "explanation": "Bước 1 quan trọng nhất: Chặn đứng dòng tiền tẩu tán tức thì trong 60 giây vàng!"
              },
              {
                "id": "step-b",
                "stepText": "Đổi mật khẩu tài khoản email, mạng xã hội & ngân hàng trên thiết bị an toàn khác",
                "correctOrder": 2,
                "explanation": "Bước 2: Gia cố lại toàn bộ hạ tầng mật khẩu và thu hồi phiên đăng nhập lạ."
              },
              {
                "id": "step-c",
                "stepText": "Gọi phản ánh ngay lên Tổng đài Cục An toàn thông tin 156 hoặc NCSC",
                "correctOrder": 3,
                "explanation": "Bước 3: Cảnh báo đầu số viễn thông, tên miền giả mạo để nhà mạng kịp thời ngăn chặn diện rộng."
              },
              {
                "id": "step-d",
                "stepText": "Chụp màn hình toàn bộ bằng chứng & nộp hồ sơ trình báo Công An phường/quận gần nhất",
                "correctOrder": 4,
                "explanation": "Bước 4: Cung cấp hồ sơ pháp lý số để phục vụ điều tra và phong tỏa tài khoản thụ hưởng."
              }
            ]
          },
          {
